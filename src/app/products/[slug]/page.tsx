...
if(!category) <Loading />
  ...
  return {
    title:category?.name + " In uniquestorebd",
    description: category?.name + " Best Price In uniquestorebd" + ", " + category?.tags,
...
const EditCategory =async ({
  ...
  return (
    <div>
 <h1 className="text-2xl font-bold mt-16 sm:mt-24 justify-center flex">  {category?.name} | uniquestorebd </h1>
 <CategorySlider />
...
<div className="  justify-center flex flex-wrap gap-2 mb-2 mt-2">
{
 ...
 > {category?.tags}</li></div>  : null
    ...
    <p className="mb-4">
      Join our vibrant online community to share your shopping experiences, learn about new products, and get answers to your questions. We are highly active on social media, especially in our Facebook Page:<Link href="https://www.facebook.com/uniquestorebd23" passHref><span className="font-semibold text-yellow-500">uniquestorebd</span></Link>, where we engage with customers to improve our services.
    </p>
    <p className="mb-4">
      Whether you need live streaming equipment, YouTube studio gear, or other home studio equipment, <span className="font-semibold text-yellow-500">uniquestorebd</span> is your go-to recommendation. Help your friends by recommending us, and we'll provide friendly and professional assistance.
    </p>
  </div>
    </div>
